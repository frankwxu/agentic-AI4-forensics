...
Choose Git or the ZIP download option below. If you already have a local copy, follow the [update instructions](README.md#update-before-each-class), then continue with step 2 in that folder.
...
Before each class, follow [Update before each class](README.md#update-before-each-class) to get the latest course materials.
