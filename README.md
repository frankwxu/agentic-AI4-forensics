...
- `Lab 0-04` (`lab0_04_ai_agent`): a hands-on introduction to agent workflows
...
4. `lab0_03_llm_api_and_model_basics`
5. `lab0_04_ai_agent`
...
11. [`projects/final-project-agentscope/`](projects/final-project-agentscope/README.md)

## Final Project

After completing Labs 1 through 5, complete the [Final Project: Agentic AI Patterns](projects/final-project-agentscope/README.md). Students review agent frameworks, select one framework, and implement Reflection, Tool Use, Planning, ReAct, and Multiagent workflows for five distinct research questions.
